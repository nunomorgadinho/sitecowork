...
class WPML_Packages{
    ...
    function __construct(){
        ...
        add_action('icl_extra_options_' . (isset( $_GET['page'] ) ? $_GET['page'] : '' ), array($this,'render_forms'));
    ...
    function get_enabled_packages(){
        global $sitepress_settings;
        if(!isset($this->packages_enabled) && isset($sitepress_settings['packages_enabled'])){
