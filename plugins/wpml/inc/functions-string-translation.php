...
add_action( 'init', 'wpml_enqueue_scripts' );
...
function icl_t($context, $name, $original_value=false, &$has_translation=null){
    ...
    $default_language = isset($sitepress_settings['st']['strings_language']) ? $sitepress_settings['st']['strings_language'] : $sitepress->get_default_language();
