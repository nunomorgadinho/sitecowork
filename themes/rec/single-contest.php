...
get_header(); ?>
		...
		<div id="primary" class="content-area">
			...
			<section class="single-contest-container">
				<h1><?php _e('NoBrand Opening Video','rec'); ?></h1>
				<div class="single-image-container"><img src="<?php echo get_bloginfo('stylesheet_directory'); ?>/images/contest-image.png"/></div>
				...
				<section class="single-info">
					...
					<button class="contact-button">Apply to the Contest</button>
				</section>
